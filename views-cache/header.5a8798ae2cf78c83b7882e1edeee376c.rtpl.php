...
<!--
    Info Enter by Fernando Britto
-->
<html lang="pt-br">
  <head>
    <meta charset="UTF-8">
    <meta name="description" content="Ecommerce Info Enter">
    <meta name="keywords" content="Loja virtual, comercio eletronico">
    <meta name="author" content="Fernando Britto">    
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    
    <title>Info Enter | Store</title>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../assets/store/css/owl.carousel.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="../assets/store/img/logo.png"></a></h1>
                    </div>
                </div>
